...
MODEL_NAME = "UNet"
OPTIMIZER = "Adam"
CRITERION = "PWRSWtL" #PWRSWtL #HVLoss #MSELoss
...
LAST_MODEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "Models/SavedModels/UNet_20240415173611.pth")
